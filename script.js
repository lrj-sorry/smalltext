...
const toggleMusicBtnLogin = document.getElementById('toggle-music-login');
const toggleMusicBtnMain = document.getElementById('toggle-music-main');
...
function updateMusicButtonsText() {
    ...
    if (!backgroundMusic.src || backgroundMusic.src === window.location.href) {
        const btnText = '无音乐文件';
        toggleMusicBtnLogin.textContent = btnText;
        toggleMusicBtnMain.textContent = btnText;
        return;
    }
